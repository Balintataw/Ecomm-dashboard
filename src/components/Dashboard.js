...
import UserImg from "../assets/images/buddy-christ.jpg";

ReactFC.fcRoot(FusionCharts, Charts, Maps, USARegion);

const url = `https://sheets.googleapis.com/v4/spreadsheets/${
  process.env.REACT_APP_SPREADSHEET_ID
}/values:batchGet?ranges=Sheet1&majorDimension=ROWS&key=${process.env.REACT_APP_SHEETS_API_KEY}`;
        ...
        this.setState(
          {
            ...
            selectedValue: rows[rows.length - 1].month
          },
          () => this.getData(rows[rows.length -1].month)
        );
      });
  }
        ...
        <Nav className="navbar navbar-expand-lg fixed-top is-white is-dark-text">
          ...
          <Container className="navbar-nav ml-auto">
            <Container className="user-detail-section">
              <span className="pr-2">Hi, Buddy</span>
